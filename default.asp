<!--#include file="./api/includes/constantes.asp"-->
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
        ...
        <div class="fix-12-12">
          <ul class="grid">
            <li class="col-6-12 left">
              <h1 class="ae-2 fromLeft">Benefícios da Hospedagem</h1>
              <p class="ae-3 fromLeft"><span class="opacity-8">Hmm, está com dúvida sobre o que a hospedagem pode facilitar pra você?, simples, assista os videos ao lado que vamos tirar todas as suas dúvidas. =)</span></p>
              <ul class="tabs controller uppercase bold ae-4 fromCenter" data-slider-id="60-1">
                <li class="selected">O que é Dominio?</li>
              ...
              <ul class="slider animated margin-top-4" data-slider-id="60-1">
                <li class="selected fromCenter">
                  <div class="popupTrigger videoThumbnail shadow rounded" data-popup-id="60-1">
                    <img class="wide" src="assets/img/logo_video_1.png" alt="Video Thumbnail"/>
                  </div>
                </li>
                <li class="fromCenter">
                  <div class="popupTrigger videoThumbnail shadow rounded" data-popup-id="60-2">
                    <img class="wide" src="assets/img/logo_video_2.png" alt="Video Thumbnail"/>
                  </div>
                </li>
              </ul>
            </li>
      ...
      <div class="wrap">
        <div class="fix-10-12">
          <div class="embedVideo popupContent">
            <iframe src="./assets/videos/video_1.mp4" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
        <div class="fix-10-12">
          <div class="embedVideo popupContent">
            <iframe src="./assets/videos/video_2.mp4" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="fix-12-12">
          <ul class="flex verticalCenter">
            <li class="col-5-12 cell-27">
              <div class="fix-4-12">
                <ul class="slider clickable ae-1 fromAbove" data-slider-id="27-2">
                  <li class="selected"><img src="assets/img/logo_cocacola.png" alt="Apple Watch Thumbnail"/></li>
                  <li><img src="assets/img/logo_creatise.png" alt="Apple Watch Thumbnail"/></li>
                </ul>
            ...
            <li class="col-7-12 left">
              <h1 class="ae-2 fromRight">Nossos Cases</h1>
              <div class="ae-3 fromRight">
                <p class="opacity-8">Alguns de nossos clientes que ja deixaram a maneira convencional de hospedagem de lado para entrar no futuro da Sos Hospedagens.</p>
              </div>
              <div class="relative">
        ...
        <div class="fix-12-12">
          <ul class="flex reverse verticalCenter">
            <li class="col-7-12 left cell-26">
              <h1 class="ae-1 fromLeft">Tempo é Recurso</h1>
              <div class="ae-2 fromLeft">
                <p class="opacity-8">Quanto mais tempo investido em serviços que te deixam na mão, você desperdiça seus recursos, a Sos Hospedagens trata os seus recursos como Obra Prima.</p>
              </div>
              <div class="relative">
        ...
        <div class="fix-12-12 toCenter">
          ...
          <ul class="grid fixedSpaces left margin-top-10">
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-4 fromLeft">
             <h3>Inspiração</h3>
             <p class="tiny opacity-6">Nos inspiramos em nossos clientes para oferecer os melhores planos</p>
            </li>
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-5 fromLeft">
             <h3>Acessibilidade</h3>
             <p class="tiny opacity-6">Nossos planos são diferenciais de todo o mercado atendendo a todos os tipos de projetos</p>
            </li>
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-6 fromLeft">
             <h3>Servidores VIP</h3>
             <p class="tiny opacity-6">Contamos com servidores robustos para atender a todos os tipos de projetos</p>
            </li>
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-7 fromLeft">
             <h3>Suporte Top</h3>
             <p class="tiny opacity-6">Conte com a ajuda do nosso suporte que está sempre pronto para lhe ajudar</p>
            </li>
          </ul>
        </div>
